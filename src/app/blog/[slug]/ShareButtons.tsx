...
/**
 * The only interactive part of a blog post — split out so the article itself
 * stays a server component and ships as HTML.
 */
export default function ShareButtons({ title, url }: { title: string; url: string }) {
  const handleShare = async (platform: string) => {
    // Prefer the address actually in the bar (covers preview domains and
    // query strings); fall back to the canonical URL rendered on the server.
