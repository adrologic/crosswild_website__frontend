        ...
        <div className="w-full px-6 lg:px-16 xl:px-24 max-w-6xl mx-auto space-y-12">
          ...
          <div className="text-center bg-primary/5 dark:bg-primary/10 rounded-2xl p-8 border border-primary/20">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/products?category=caps" className="bg-primary/10 text-primary border-2 border-primary px-8 py-3 rounded-lg font-semibold hover:bg-primary hover:text-white transition-colors">Explore All Caps →</Link>
