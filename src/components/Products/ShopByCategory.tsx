          ...
          <div className="relative">
            ...
            >
              {currentProducts.map((product) => {
                ...
                <div
                  key={product.id}
                  className="flex-none w-72 group bg-card-bg rounded-[22px] p-[14px] shadow-[0_14px_30px_rgba(22,36,59,0.16)] hover:-translate-y-[5px] hover:shadow-[0_22px_44px_rgba(22,36,59,0.24)] transition-all duration-[220ms] ease-out"
                >
                  {/* Image */}
